...
X_train, X_test, y_train, y_test = train_test_split(news['TITLE'], news['CATEGORY'], random_state = 3, test_size = 0.2)
...
# display accuracies
print('acc using vectorization', acc_count_nb)
print('accuracy using tfidf', acc_tfidf_nb)
# Code ends here
